 ...
 * preemptive shortest job first method. 
 * this method first create some random process object and then create a preemptive SJF object and add those processes
...
public class Test_PSJF {
	...
	public static void main(String[] args) {
		...
		Preemptive_SJF nsjf1 = new Preemptive_SJF();
		...
		LinkedList<Preemptive_SJF.Process> res = nsjf1.getProcessedlist();

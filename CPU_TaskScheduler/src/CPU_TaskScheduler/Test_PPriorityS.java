 ...
 * this method first create some random process object and then create a preemptive PriorityS object and add those processes
...
public static void main(String[] args) {
		...
		Preemptive_PriorityS nsjf1 = new Preemptive_PriorityS();
		...
		LinkedList<Preemptive_PriorityS.Process> res = nsjf1.getProcessedlist();

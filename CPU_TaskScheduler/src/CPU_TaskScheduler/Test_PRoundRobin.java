 ...
 * preemptive round robin scheduling method. 
 * this method first create some random process object and then create a preemptive Round Robin object and add those processes
...
public static void main(String[] args) {
		...
		Preemptive_RoundRobin nsjf1 = new Preemptive_RoundRobin(2l);
		...
		LinkedList<Preemptive_RoundRobin.Process> res = nsjf1.getProcessedlist();

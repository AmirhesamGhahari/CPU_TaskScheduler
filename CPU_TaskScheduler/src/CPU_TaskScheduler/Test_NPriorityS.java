 ...
 * nonpreemptive priority scheduling method. 
 * this method first create some random process object and then create a Nonpreemptive PriorityS object and add those processes
...
public static void main(String[] args) {
		...
		Nonpreemptive_PriorityS nsjf1 = new Nonpreemptive_PriorityS();
		nsjf1.addProcess(2, l1);
		nsjf1.addProcess(4, l2);
		nsjf1.addProcess(1, l3);
		nsjf1.addProcess(5, l4);
		nsjf1.addProcess(2, l5);
		
		
		long[] tr = nsjf1.processScheduling();
		LinkedList<Nonpreemptive_PriorityS.Process> res = nsjf1.getProcessedlist();

...
/**
 * 
 * Preemptive priority scheduling class 
 * 
 */
public class Preemptive_PriorityS {
	
	/**
	 * linked list object responsible for holding the cpu task burst processes
	 */
	private ArrayList<Preemptive_PriorityS.Process> computationList;
	
	/**
	 * linked list object responsible for holding the I/O task burst processes
	 */
	private LinkedList<Preemptive_PriorityS.Process> IOList;

	/**
	 * linked list object responsible for holding the already processed and terminated processes
	 */
	private LinkedList<Preemptive_PriorityS.Process> processedProcesses;
	 ...
	 */
	public Preemptive_PriorityS() {
		
		this.computationList =  new ArrayList<Preemptive_PriorityS.Process>();
		this.IOList = new LinkedList<Preemptive_PriorityS.Process>();
		this.processedProcesses = new LinkedList<Preemptive_PriorityS.Process>();
	}
	 ...
	 */
	public LinkedList<Preemptive_PriorityS.Process> getProcessedlist()
	{

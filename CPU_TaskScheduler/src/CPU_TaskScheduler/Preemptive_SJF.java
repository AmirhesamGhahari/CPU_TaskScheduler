...
/**
 * 
 * Preemptive shortest job first scheduling class 
 * 
 */
public class Preemptive_SJF {
	 ...
	 */
	private ArrayList<Preemptive_SJF.Process> computationList;
	
	/**
	 * linked list object responsible for holding the I/O task burst processes
	 */
	private LinkedList<Preemptive_SJF.Process> IOList;

	/**
	 * linked list object responsible for holding the already processed and terminated processes
	 */
	private LinkedList<Preemptive_SJF.Process> processedProcesses;;
	 ...
	 */
	public Preemptive_SJF() {
		
		this.computationList =  new ArrayList<Preemptive_SJF.Process>();
		this.IOList = new LinkedList<Preemptive_SJF.Process>();
		this.processedProcesses = new LinkedList<Preemptive_SJF.Process>();
	}
	 ...
	 */
	public LinkedList<Preemptive_SJF.Process> getProcessedlist()
	{
